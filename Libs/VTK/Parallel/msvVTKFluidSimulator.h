...
#ifndef __msvVTKFluidSimulator_h
#define __msvVTKFluidSimulator_h
...
class MSV_VTK_PARALLEL_EXPORT msvVTKFluidSimulator : public vtkObject
{
public:
  static msvVTKFluidSimulator* New();
  vtkTypeMacro(msvVTKFluidSimulator,vtkObject)
  ...
  // Description:
  // Set / Get time step
  vtkSetMacro(DtGrowFactor,double);
  vtkGetMacro(DtGrowFactor,double);
...
protected:
  msvVTKFluidSimulator();
  virtual ~msvVTKFluidSimulator();
...
private:
  msvVTKFluidSimulator(const msvVTKFluidSimulator&);  // Not implemented.
  void operator=(const msvVTKFluidSimulator&);  // Not implemented.
};
